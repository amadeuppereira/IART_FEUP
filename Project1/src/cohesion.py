...
def game_intro(LEVEL):
    ...
    while intro:
        ...
        button("Player",120,350,100,50,DARK_GREEN,BRIGHT_GREEN,player_game_loop, LEVEL)
        button("Computer",380,350,100,50,DARK_GREEN,BRIGHT_GREEN,computer_game_loop, LEVEL)
        button("Exit",250,450,100,50,DARK_RED,BRIGHT_RED,quitgame)

        pygame.display.update()
        clock.tick(15)

def player_game_loop(LEVEL) :
